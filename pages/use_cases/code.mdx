...
* [使用Deep Lake分析Twitter算法代码库](code/twitter-the-algorithm-analysis-deeplake)：一个演示如何解析github源代码并运行查询对话的笔记本。
* [使用Deep Lake分析LangChain代码库](code/code-analysis-deeplake)：一个演示如何分析并对这个代码库进行问答的笔记本。
