 ...
 [#](#evaluating-an-openapi-chain "Permalink to this headline")
=============================================================================================



 This notebook goes over ways to semantically evaluate an
 
 OpenAPI Chain
 
 , which calls an endpoint defined by the OpenAPI specification using purely natural language.
...
```
 ...
 Load the API Chain
 [#](#load-the-api-chain "Permalink to this headline")
---------------------------------------------------------------------------
...
### 
*Optional* 
 : Generate Input Questions and Request Ground Truth Queries
 [#](#optional-generate-input-questions-and-request-ground-truth-queries "Permalink to this headline")
 ...
 at the end of this notebook for more details.
...
```
 ...
 Run the API Chain
 [#](#run-the-api-chain "Permalink to this headline")
-------------------------------------------------------------------------
...
```
 ...
 [#](#evaluate-the-requests-chain "Permalink to this headline")
---------------------------------------------------------------------------------------------
...
```
 ...
 [#](#evaluate-the-response-chain "Permalink to this headline")
---------------------------------------------------------------------------------------------
...
```
 ...
 Generating Test Datasets
 [#](#generating-test-datasets "Permalink to this headline")
---------------------------------------------------------------------------------------
 ...
 First, we’ll parse the OpenAPI Spec. For this example, we’ll
 [Speak](https://www.speak.com/) 
 ’s OpenAPI specification.
