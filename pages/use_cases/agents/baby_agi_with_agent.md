...
BabyAGI带工具[#](#babyagi-with-tools "此标题的永久链接")
===========
...
本文档基于[baby agi](baby_agi.html)，，但演示了如何更换执行链。之前的执行链只是一个LLM，胡编乱造。通过用具有工具访问权限的代理替换它，我们可以希望获得真正可靠的信息

安装和导入所需模块[#](#install-and-import-required-modules "此标题的永久链接")
-------------------------
...
### 连接到向量存储[#](#connect-to-the-vector-store "此标题的永久链接")
...
定义链[#](#define-the-chains "此标题的永久链接")
-----------------
