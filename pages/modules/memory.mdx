...
[概念指南](https://docs.langchain.com.cn/docs/components/memory) 
...
* [记忆内存 （Memory）入门](./memory/getting_started) 
：内存组件的概述以及如何使用它们。
* [Types类别](./memory/how_to_guides#types类别) 
：有关LangChain使用的存储系统的内存存储的详细信息。
* [usage用法](./memory/how_to_guides#usage用法) 
：LangChain链中记忆使用的示例。