...
```
 ...
 [#](#loading-multiple-webpages "Permalink to this headline")
-----------------------------------------------------------------------------------------
...
### 
 ...
 [#](#load-multiple-urls-concurrently "Permalink to this headline")
...
```
 ...
 [#](#loading-a-xml-file-or-using-a-different-beautifulsoup-parser "Permalink to this headline")
----------------------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 `SitemapLoader`
 for an example of how to load a sitemap file, which is an example of using this feature.
