 ...
 CSV Loader
 [#](#csv-loader "Permalink to this headline")
===========================================================
...
```
 ...
 [#](#customizing-the-csv-parsing-and-loading "Permalink to this headline")
---------------------------------------------------------------------------------------------------------------------
...
```
 ...
 [#](#specify-a-column-to-be-used-identify-the-document-source "Permalink to this headline")
-------------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 Use the
 `source_column`
 argument to specify a column to be set as the source for the document created from each row. Otherwise
 `file_path`
