...
---------------------------------------------------------------------------------------------------
```
alchemyApiKey = "get from https://www.alchemy.com/ and set in environment variable ALCHEMY\_API\_KEY"
```
### 
...
blockchainLoader = BlockchainDocumentLoader(contract\_address=contractAddress,
