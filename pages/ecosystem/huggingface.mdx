...
抱抱脸Huggingface[#](#hugging-face "此标题的永久链接")
=================================

本页面介绍如何在LangChain中使用抱抱脸huggingface生态系统（包括[抱抱脸huggingface中心](https://huggingface.co))。  
...
有关Hugging Face Hub包装器的更详细演练，请参见[这个notebook](../modules/model_io/llms/integrations/huggingface_hub)
...
有关更详细的操作说明，请参见[此教程电脑](../modules/model_io/text_embedding/examples/huggingfacehub)
